    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
                <a class="nav-link" href="controller?command=applicationPage"><fmt:message
                        key="client.menu.button.submit.application"/> <span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="controller?command=freeRoomsPage"><fmt:message
                        key="client.menu.button.book"/></a>
            </li>
        </ul>
